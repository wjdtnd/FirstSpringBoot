package kr.ac.kopo.lhn.firstspringboot.controller;
...
public class Example06Controller {
    ...
    public String requestMethod2(ModelMap modelMap) {
        ...
        modelMap.addAttribute("message2","ModelMap 클래스는 Model 인터페이스의 기능(메소드)과 동일하거나 더 확장된 기능을 사용할 수 있다.");
    ...
    //  ModelView.setViewName("viewPageModelAndView"); 이것도 가능함
        ...
        modelView.addObject("msg4","ModelAndView 클래스는 요청 메소드의 매개변수를 통해 사용하는 것이 아니라 객체 생성을 해서 사용해야하며, 리턴 값으로는 ModelAndView 객체의 참조값을 사용한다.");
